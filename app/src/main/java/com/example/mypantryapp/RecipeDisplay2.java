...
import com.example.mypantryapp.databinding.RecipeDisplay2Binding;

public class RecipeDisplay2 extends Fragment {

    private RecipeDisplay2Binding binding;
    ...
    public View onCreateView(
        ...
        binding = RecipeDisplay2Binding.inflate(inflater, container, false);
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        binding.backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                NavHostFragment.findNavController(RecipeDisplay2.this)
                        .navigate(R.id.action_closeDisplayRecipe2);
            }
        });
